...
| Diagram                      | Path                                                                      |
| ---------------------------- | ------------------------------------------------------------------------- |
| Platform Infrastructure View | [diagrams/enterprise-ai-platform-reference-architecture-Infrastructure View.png](diagrams/enterprise-ai-platform-reference-architecture-Infrastructure%20View.png) |
