...
|Resource|URL|
|---|---|
|Trusted Workspace Access in Microsoft Fabric|[https://learn.microsoft.com/en-us/fabric/security/security-trusted-workspace-access](https://learn.microsoft.com/en-us/fabric/security/security-trusted-workspace-access)|
|Private ADLS Gen2 access with OneLake Shortcuts (step-by-step)|[https://blog.fabric.microsoft.com/en-US/blog/private-adls-gen2-access-made-easy-with-onelake-shortcuts-a-step-by-step-guide/](https://blog.fabric.microsoft.com/en-US/blog/private-adls-gen2-access-made-easy-with-onelake-shortcuts-a-step-by-step-guide/)|
|OneLake shortcuts overview|[https://learn.microsoft.com/en-us/fabric/onelake/onelake-shortcuts](https://learn.microsoft.com/en-us/fabric/onelake/onelake-shortcuts)|
|Fabric managed private endpoints overview|[https://learn.microsoft.com/en-us/fabric/security/security-managed-private-endpoints-overview](https://learn.microsoft.com/en-us/fabric/security/security-managed-private-endpoints-overview)|
|MPE shortcut feature request (community)|[https://community.fabric.microsoft.com/t5/Fabric-Ideas/Enable-OneLake-shortcut-connections-using-Managed-Private/idi-p/4910267](https://community.fabric.microsoft.com/t5/Fabric-Ideas/Enable-OneLake-shortcut-connections-using-Managed-Private/idi-p/4910267)|
|Fabric core patterns for accessing private data sources (Microsoft, Jan 2026)|[https://medium.com/microsoftazure/microsoft-fabric-core-patterns-for-accessing-private-data-sources-2631c4cd0c4d](https://medium.com/microsoftazure/microsoft-fabric-core-patterns-for-accessing-private-data-sources-2631c4cd0c4d)|
|Foundry network isolation (private link)|[https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/configure-private-link](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/configure-private-link)|
|Fabric tenant-level private links overview|[https://learn.microsoft.com/en-us/fabric/security/security-private-links-overview](https://learn.microsoft.com/en-us/fabric/security/security-private-links-overview)|
|Fabric workspace-level private links overview|[https://learn.microsoft.com/en-us/fabric/security/security-workspace-level-private-links-overview](https://learn.microsoft.com/en-us/fabric/security/security-workspace-level-private-links-overview)|
|Fabric workspace-level private links: supported scenarios and limitations|[https://learn.microsoft.com/en-us/fabric/security/security-workspace-level-private-links-support](https://learn.microsoft.com/en-us/fabric/security/security-workspace-level-private-links-support)|
|VNet Data Gateway GA for Fabric Pipeline, Dataflow Gen2, Copy Job|[https://blog.fabric.microsoft.com/en-us/blog/virtual-network-data-gateway-support-for-fabric-pipeline-dataflow-gen2-fast-copy-and-copy-job-is-now-generally-available/](https://blog.fabric.microsoft.com/en-us/blog/virtual-network-data-gateway-support-for-fabric-pipeline-dataflow-gen2-fast-copy-and-copy-job-is-now-generally-available/)|
|OneLake access API and URI syntax|[https://learn.microsoft.com/en-us/fabric/onelake/onelake-access-api](https://learn.microsoft.com/en-us/fabric/onelake/onelake-access-api)|
|Azure Private DNS Zones|[https://learn.microsoft.com/en-us/azure/dns/private-dns-overview](https://learn.microsoft.com/en-us/azure/dns/private-dns-overview)|
|Azure Monitor Private Link Scope|[https://learn.microsoft.com/en-us/azure/azure-monitor/logs/private-link-security](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/private-link-security)|
|Azure Container Apps networking|[https://learn.microsoft.com/en-us/azure/container-apps/networking](https://learn.microsoft.com/en-us/azure/container-apps/networking)|
|Azure Container Apps managed identities|[https://learn.microsoft.com/en-us/azure/container-apps/managed-identity](https://learn.microsoft.com/en-us/azure/container-apps/managed-identity)|
|Foundry trusted Azure services|[https://learn.microsoft.com/en-us/azure/ai-services/cognitive-services-virtual-networks](https://learn.microsoft.com/en-us/azure/ai-services/cognitive-services-virtual-networks)|
|Fabric workspace identity|[https://learn.microsoft.com/en-us/fabric/security/workspace-identity](https://learn.microsoft.com/en-us/fabric/security/workspace-identity)|
|ADLS Gen2 resource instance rules|[https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security](https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security)|
|Create a resource instance network rule for Azure Storage|[https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security-resource-instances](https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security-resource-instances)|
|Azure Storage firewall guidelines and limitations|[https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security-limitations](https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security-limitations)|
|Setting up OneLake shortcuts to ADLS Gen2 with private endpoint and TWA|[https://codeserendipity.com/2025/09/08/microsoft-fabric-secure-onelake-shortcut-to-adls-gen2-vnet-private-endpoint-trusted-workspace-and-service-principal/](https://codeserendipity.com/2025/09/08/microsoft-fabric-secure-onelake-shortcut-to-adls-gen2-vnet-private-endpoint-trusted-workspace-and-service-principal/)|
|Azure Service Bus private endpoints|[https://learn.microsoft.com/en-us/azure/service-bus-messaging/private-link-service](https://learn.microsoft.com/en-us/azure/service-bus-messaging/private-link-service)|
|Azure SQL Database private endpoints|[https://learn.microsoft.com/en-us/azure/azure-sql/database/private-endpoint-overview](https://learn.microsoft.com/en-us/azure/azure-sql/database/private-endpoint-overview)|
|AI Search indexer access to protected resources|[https://learn.microsoft.com/en-us/azure/search/search-indexer-securing-resources](https://learn.microsoft.com/en-us/azure/search/search-indexer-securing-resources)|
|AI Search indexer trusted service exception|[https://learn.microsoft.com/en-us/azure/search/search-indexer-howto-access-trusted-service-exception](https://learn.microsoft.com/en-us/azure/search/search-indexer-howto-access-trusted-service-exception)|
|AI Search managed identity connection to Storage|[https://learn.microsoft.com/en-us/azure/search/search-howto-managed-identities-storage](https://learn.microsoft.com/en-us/azure/search/search-howto-managed-identities-storage)|
|AI Search managed identity configuration|[https://learn.microsoft.com/en-us/azure/search/search-how-to-managed-identities](https://learn.microsoft.com/en-us/azure/search/search-how-to-managed-identities)|
|Azure Storage lifecycle management|[https://learn.microsoft.com/en-us/azure/storage/blobs/lifecycle-management-overview](https://learn.microsoft.com/en-us/azure/storage/blobs/lifecycle-management-overview)|
|Azure Policy built-in definitions and custom policy guidance|[https://learn.microsoft.com/en-us/azure/governance/policy/overview](https://learn.microsoft.com/en-us/azure/governance/policy/overview)|
|Private endpoints for Azure Storage|[https://learn.microsoft.com/en-us/azure/storage/common/storage-private-endpoints](https://learn.microsoft.com/en-us/azure/storage/common/storage-private-endpoints)|